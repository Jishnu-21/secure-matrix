...
const Header = () => {
  ...
  const menuItems: MenuItem[] = [
    ...
    { 
      ...
      path: "#",
      dropdown: [
        { name: "SECURE GABION BOX ", path: "/products/gabion-box" },
        { name: "SECURE GABION  MATTRESS ", path: "/products/gabion-mattress" },
        { name: "SECURE ROCK FALL NETTING", path: "/products/rockfall-netting" },
        { name: "SECURE WIRE ROPE PANEL", path: "/products/wirerope-panel" },
        { name: "SECURE TERRAIN MESH", path: "/products/terrain-mesh" },
        { name: "SECURE EROSION CONTROL BLANKETS", path: "/products/erosion-control" },
        { name: "SECURE MESH SYSTEM", path: "/products/mesh-system" },
        { name: "SECURE DRAINAGE COMPOSITE", path: "/products/drainage-composite" },
        { name: "SECURE GRID SYSTEM", path: "/products/grid-system" },
        { name: "SECURE GEO STRAP", path: "/products/geo-strap" },
        { name: "DOUBLE SECUREMESH SYSTEM", path: "/products/double-securemesh" },
        { name: "SECURE COIR MAT", path: "/products/coir-mat" },
        { name: "SECURE GEOBAG", path: "/products/geobag" },
        ...
        { name: "SECURE GEO CELL", path: "/products/geo-cell" },
        { name: "SECURELINK-GEOGRID", path: "/products/geo-grid" },
        { name: "GREEN SECUREMESH SYSTEM", path: "/products/green-mesh" },
        { name: "SECURE GREEN TERRAIN MESH", path: "/products/green-terrain-mesh" },  
