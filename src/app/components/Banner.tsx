        ...
        <div className="relative z-10 h-full w-full flex items-start pt-[70px] sm:pt-[80px] md:pt-[90px] lg:pt-[110px] xl:pt-[120px]">
          <div className="w-full px-4 sm:px-5 md:px-6 lg:px-8 max-w-[1440px] mx-auto">
            <div className="space-y-3 max-w-[700px] text-left">
              <h2 className="text-lg sm:text-2xl md:text-2xl lg:text-2xl xl:text-4xl font-medium text-white leading-[1.2]">
                We are 'The Guardians of Every Territory'.
              </h2>
            </div>
            <p className="text-xs sm:text-xl md:text-base lg:text-sm xl:text-xl text-white/95 mt-3 sm:mt-5 mb-7 sm:mb-11 leading-[1.8] max-w-[500px] font-light tracking-wide text-left">
